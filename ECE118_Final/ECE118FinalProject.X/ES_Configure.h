...
typedef enum {
    ...
    FRONT_BUMPER_TRIPPED,
    FRONT_BUMPER_NOT_TRIPPED,
    BALLS_LAUNCHED,
            
    FRONT_SENSOR_UPDATED,
    REAR_SENSOR_UPDATED,
    RIGHT_SENSOR_UPDATED,
    LEFT_SENSOR_UPDATED,
    ...
    REAR_LEFT_BUMPER_TRIPPED,
    REAR_RIGHT_BUMPER_TRIPPED,
    REAR_BUMPERS_TRIPPED,
...
#define EVENT_CHECK_LIST PingCheck, StepCheck, CheckBeacon, FrontBumperCheck, RearBumperCheck
...
#define ROBOT_TIMER 0 /*make sure this is enabled above and posting to the correct state machine*/
#define MOVEMENT_TIMER 1
#define LAUNCHER_TIMER 2
#define RELOAD_TIMER 3
#define BUMPER_TIMER 4
#define WAIT_TIMER 5
#define OBSTACLE_TIMER 6
/****************************************************************************/
...
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "HSM_Robot.h"
// the name of the Init function
...
#if NUM_SERVICES > 2
// the header file with the public fuction prototypes
#define SERV_2_HEADER "Service_Bumper.h"
// the name of the Init function

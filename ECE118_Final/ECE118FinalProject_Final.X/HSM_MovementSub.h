...
#ifndef SUB_MOVEMENT_HSM_H  // <- This should be changed to your own guard on both
#define SUB_MOVEMENT_HSM_H  //    of these lines
...
/**
 * @Function InitMovementSubHSM(void)
...
/**
 * @Function RunMovementSubHSM(ES_Event ThisEvent)

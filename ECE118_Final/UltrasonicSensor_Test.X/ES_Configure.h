...
#define EVENT_CHECK_LIST PingCheck
...
#define TIMER0_RESP_FUNC PostNAVFSM
...
// the name of the Init function
#define SERV_1_INIT InitNAVFSM
// the name of the run function
#define SERV_1_RUN RunNAVFSM
...
#if NUM_SERVICES > 2
// the header file with the public fuction prototypes
#define SERV_2_HEADER "problem6c.h"
// the name of the Init function
#define SERV_2_INIT InitTUSFSM
// the name of the run function
#define SERV_2_RUN RunUSFSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public fuction prototypes
#define SERV_3_HEADER "part3.h"
// the name of the Init function
#define SERV_3_INIT InitADCService
// the name of the run function
#define SERV_3_RUN RunADCService
// How big should this services Queue be?
